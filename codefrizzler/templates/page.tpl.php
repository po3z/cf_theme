...
<div id="page" class="container <?php print $classes; ?>">
  ...
  <!-- region: Leaderboard -->
  <nav class="menu-top" id="primary_navigation">
    <?php if ($primary_navigation): print theme('nice_menus_main_menu'); endif; ?>
  </nav>
  ...
  <nav id="primary_navigation"><?php if ($primary_navigation): print theme('nice_menus_main_menu'); endif; ?></nav>
  <nav id="secondary_navigation"><?php if ($secondary_navigation): print theme('nice_menus_secondary_menu'); endif; ?></nav>
